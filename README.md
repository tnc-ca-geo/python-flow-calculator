...
## Known Differences
   ...
   1. Data filtering: 
      ...
      The updated calculator requires at least 350 days of data per water year and allows up to 7 days of consecutive missing data. The previous recommendation was to require 358 days of data to run a year. These differences may result in slight changes in metrics that are summarized over multiple years, including peak flow metrics.
