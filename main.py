...
if __name__ == '__main__':
    ...
    if alterationNeeded is None:
        ...
        box_plots = questionary.confirm("Would you like the flow calculator to produce box plots for the alteration assessment?").ask()
    ...
    try:
        ...
        warning_message = assess_alteration(gage_arr, alteration_files, output_files = output_files_dir, aa_start_year=aa_start_year, aa_end_year=aa_end_year, wyt_list = alteration_list, box_plots = box_plots)
