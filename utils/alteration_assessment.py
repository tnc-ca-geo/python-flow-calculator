...
def compare_data_frames(raw_metrics, predicted_metrics, raw_percentiles, count, wyt):
    ...
    if total_years_used < 20 and wyt == 'any':
        warning_message = 'At least 20 years of data are recommended for a peak flows analysis for an alteration assessment. Peak flow metrics and alteration assessment may not be accurate.\n'
